...
class CNN(object):
    ...
    def Position_Embedding(self,position_size):
        ...
        position_embedding = tf.tile(position_i,[1,position_size])
        #position_embedding = position_embedding.reshape(self.vocab_size,position_size)
        ...
        tf.repeat [1,embedding] ,repeat vocab_size = vocab_size,embedding
                  [vocab,1] ,  repeat embedding = vocab_size,embedding
 		'''
